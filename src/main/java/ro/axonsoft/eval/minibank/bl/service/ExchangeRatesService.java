...
import ro.axonsoft.eval.minibank.bl.dto.ExchangeRatesProperties;
...
public class ExchangeRatesService {
    ...
    public BigDecimal convert(BigDecimal amount, Currency sourceCurrency, Currency targetCurrency){
        ...
        BigDecimal srcToRon = getRate(sourceCurrency);
        BigDecimal targetToRon = getRate(targetCurrency);
